...
public static class GameStrings
{
    ...
    public static class GameStringsEnglish
    {
        ...
        public static string optionsModifiedSetting = "This setting has been <color=" + Colors.textRed + ">Modified</color>. Click the button at the <color=" + Colors.textRed + ">bottom left</color> of this screen to revert all modified settings.";
        ...
        public static string optionsGoreDesc = "Allow <color=" + Colors.textRed + ">blood</color> effects and <color=" + Colors.textRed + ">dismemberment</color>, this will also effect the <color=" + Colors.textOrange + ">Fragment</color> property if it is taken.";
        ...
        public static string optionsVSyncDescAdditional = "<color=" + Colors.textRed + ">[</color>Off<color=" + Colors.textRed + ">]</color>\r\nFrames limited to <color=" + Colors.textRed + ">Framerate Cap</color>.\r\n\r\n\r\n<color=" + Colors.textRed + ">[</color>V<color=" + Colors.textRed + "><b>-</b></color>Blank<color=" + Colors.textRed + ">]</color>\r\nFrames limited to monitors <color=" + Colors.textRed + ">maximum</color> refresh rate.\r\n\r\n\r\n<color=" + Colors.textRed + ">[</color>Second V<color=" + Colors.textRed + "><b>-</b></color>Blank<color=" + Colors.textRed + ">]</color>\r\nFrames limited to <color=" + Colors.textRed + ">HALF</color> monitors <color=" + Colors.textRed + ">maximum</color> refresh rate.";
        ...
        public static string optionsQualityDescAdditional = "Affects the following:\r\n----------------------------------\r\n\r\n- <color=" + Colors.textRed + ">Bloom</color>\r\n- <color=" + Colors.textRed + ">Shadow Quality</color>\r\n- <color=" + Colors.textRed + ">Global Illumination</color>\r\n- <color=" + Colors.textRed + ">Global Illumination Resolution</color>\r\n- <color=" + Colors.textRed + ">Anti-Alias</color>\r\n- <color=" + Colors.textRed + ">TAA Sharpening</color>\r\n- <color=" + Colors.textRed + ">Reflections</color>\r\n- <color=" + Colors.textRed + ">Planar Reflections</color>\r\n- <color=" + Colors.textRed + ">Ansio Filtering</color>\r\n- <color=" + Colors.textRed + ">Weather Effects</color>\r\n- <color=" + Colors.textRed + ">Volumetric Fog</color>\r\n- <color=" + Colors.textRed + ">Line Rendering</color>\r\n- <color=" + Colors.textRed + ">Crevices</color>\r\n- <color=" + Colors.textRed + ">Tonemapping</color>\r\n- <color=" + Colors.textRed + ">Tonemapping Quality</color>\r\n";
        ...
        public static string optionsGlobalIlluminationResDesc = "When using <color=red>SSGI</color> or <color=red>RTGI</color> the resolution can be set to <color=red>Full</color> quality or <color=red>Half</color>.\r\n\r\n\r\n\r\nChange using the toggle at the top of this section.";
