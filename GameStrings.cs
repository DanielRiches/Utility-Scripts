...
public static class GameStrings
{
    ...
    public static class GameStringsEnglish
    {
        ...
        public static string optionsTaaQualityDesc = "When using <color=" + Colors.textRed + ">Temporal Anti Aliasing</color> (<color=" + Colors.textRed + ">TAA</color>) you can set what type of <color=" + Colors.textRed + ">sharpening</color> to use.\r\n\r\n<color=" + Colors.textRed + ">Low Quality</color> - Basic filter.\r\n<color=" + Colors.textRed + ">Post Sharpen</color> - Better quality filter.\r\n<color=" + Colors.textRed + ">Contrast Adapt</color> - Uses <color=" + Colors.textOrange + ">AMD Fidelity-FX</color>, a more advanced sharpening method.";
        public static string optionsTaaQualityDescAdditional = "<color=" + Colors.textRed + ">[</color>Low Quality<color=" + Colors.textRed + ">]</color> <color=" + Colors.textRed + ">[</color><color=" + Colors.textGreen + "><b>+++</b></color> Performance<color=" + Colors.textRed + ">]</color>\r\n-------------------------------------------------\r\n<color=" + Colors.textRed + ">[</color>Low<color=" + Colors.textRed + ">]</color>           <color=" + Colors.textGreen + "><b>+++</b></color> Performance         /     <color=" + Colors.textRed + "><b>---</b></color> Quality\r\n\r\n\r\n\r\n<color=" + Colors.textRed + ">[</color>Post Sharpen<color=" + Colors.textRed + ">]</color> <color=" + Colors.textRed + ">[</color><color=" + Colors.textGreen + "><b>+</b></color> Quality<color=" + Colors.textRed + ">]</color>\r\n-------------------------------------------------<color=" + Colors.textRed + ">[</color>Post<color=" + Colors.textRed + ">]</color>             <color=" + Colors.textRed + "><b>-</b></color> Performance         /         <color=" + Colors.textGreen + "><b>+</b></color> Quality\r\n\r\n\r\n\r\n<color=" + Colors.textRed + ">[</color>Contrast Adapt<color=" + Colors.textRed + ">]</color> <color=" + Colors.textRed + ">[</color><color=" + Colors.textGreen + "><b>+++</b></color> Quality<color=" + Colors.textRed + ">]</color>\r\n-------------------------------------------------<color=" + Colors.textRed + ">[</color>Adaptive<color=" + Colors.textRed + ">]</color>       <color=" + Colors.textRed + "><b>---</b></color> Performance     /     <color=" + Colors.textGreen + "><b>+++</b></color> Quality";
        ...
        public static string optionsGlobalIlluminationDescAdditional = "<color=" + Colors.textRed + ">[</color>Realtime<color=" + Colors.textRed + ">]</color> <color=" + Colors.textRed + ">[</color><color=" + Colors.textGreen + ">++ </color>Quality<color=" + Colors.textRed + ">]</color>\r\n-------------------------------------------------<color=" + Colors.textRed + ">[</color>Realtime<color=" + Colors.textRed + ">]</color>               </color><color=" + Colors.textRed + ">-- </color>Performance    /   <color=" + Colors.textGreen + ">++ </color>Quality<color=" + Colors.textRed + ">\r\n\r\n\r\n[</color>Raymarching - SSGI<color=" + Colors.textRed + ">]</color> <color=" + Colors.textRed + ">[</color><color=" + Colors.textGreen + ">++ </color>Performance<color=" + Colors.textRed + ">]</color>\r\n<color=" + Colors.textRed + ">[</color>Raytracing - RTGI<color=" + Colors.textRed + ">]</color> <color=" + Colors.textRed + ">[</color><color=" + Colors.textGreen + ">+++ </color>Quality<color=" + Colors.textRed + ">]</color>\r\n-------------------------------------------------<color=" + Colors.textRed + ">[</color>Low<color=" + Colors.textRed + ">]                    </color> </color><color=" + Colors.textRed + ">- </color> Performance    /       <color=" + Colors.textGreen + ">+ </color>Quality\r\n<color=" + Colors.textRed + ">[</color>Medium<color=" + Colors.textRed + ">]           </color>  </color><color=" + Colors.textRed + ">-- </color>Performance     /     <color=" + Colors.textGreen + ">++ </color>Quality\r\n<color=" + Colors.textRed + ">[</color>High<color=" + Colors.textRed + ">]</color> </color>               <color=" + Colors.textRed + ">---</color> Performance     /    <color=" + Colors.textGreen + ">+++ </color>Quality\r\n";
        ...
        public static string optionsGlobalIlluminationResDescAdditional = "<color=" + Colors.textRed + ">[</color>On<color=" + Colors.textRed + ">]</color> <color=" + Colors.textRed + ">[</color><color=" + Colors.textGreen + ">++ </color>Quality<color=" + Colors.textRed + ">]</color>\r\n-------------------------------------------------<color=" + Colors.textRed + ">[</color>On<color=" + Colors.textRed + ">]</color>                           </color><color=" + Colors.textRed + ">- </color>Performance    /   <color=" + Colors.textGreen + ">++ </color>Quality\r\n\r\n\r\n<color=" + Colors.textRed + ">[</color>Off<color=" + Colors.textRed + ">]</color> <color=" + Colors.textRed + ">[</color><color=" + Colors.textGreen + ">+++ </color>Performance<color=" + Colors.textRed + ">]</color>\r\n-------------------------------------------------<color=" + Colors.textRed + ">[</color>Off<color=" + Colors.textRed + ">]                    </color> </color><color=" + Colors.textGreen + ">+++ </color> Performance    /   <color=" + Colors.textRed + ">-- </color>Quality";
        public static string optionsGlobalIlluminationResStatusDesc = "When using <color=" + Colors.textRed + ">SSGI</color> or <color=" + Colors.textRed + ">RTGI</color> the resolution can be set to <color=" + Colors.textRed + ">Full</color> quality or <color=" + Colors.textRed + ">Half</color> to save performance using the toggle above this area.";
        ...
        public static string optionsReflectionsDescAdditional = "<color=" + Colors.textRed + ">[</color>Realtime<color=" + Colors.textRed + ">]</color> <color=" + Colors.textRed + ">[</color><color=" + Colors.textGreen + ">++ </color>Quality<color=" + Colors.textRed + ">]</color>\r\n-------------------------------------------------<color=" + Colors.textRed + ">[</color>Realtime<color=" + Colors.textRed + ">]</color>               </color><color=" + Colors.textRed + ">-- </color>Performance    /   <color=" + Colors.textGreen + ">++ </color>Quality<color=" + Colors.textRed + ">\r\n\r\n\r\n[</color>Raymarching - SSR<color=" + Colors.textRed + ">]</color> <color=" + Colors.textRed + ">[</color><color=" + Colors.textGreen + ">++ </color>Performance<color=" + Colors.textRed + ">]</color>\r\n<color=" + Colors.textRed + ">[</color>Raytracing - RTR<color=" + Colors.textRed + ">]</color> <color=" + Colors.textRed + ">[</color><color=" + Colors.textGreen + ">+++ </color>Quality<color=" + Colors.textRed + ">]</color>\r\n-------------------------------------------------<color=" + Colors.textRed + ">[</color>Low<color=" + Colors.textRed + ">]                    </color> </color><color=" + Colors.textRed + ">- </color> Performance    /       <color=" + Colors.textGreen + ">+ </color>Quality\r\n<color=" + Colors.textRed + ">[</color>Medium<color=" + Colors.textRed + ">]           </color>  </color><color=" + Colors.textRed + ">-- </color>Performance     /     <color=" + Colors.textGreen + ">++ </color>Quality\r\n<color=" + Colors.textRed + ">[</color>High<color=" + Colors.textRed + ">]</color> </color>               <color=" + Colors.textRed + ">---</color> Performance     /    <color=" + Colors.textGreen + ">+++ </color>Quality\r\n";
        public static string optionsPlanarReflectionsDesc = "<color=red>Planar Reflections</color> can be used in addition to other reflection methods to increase quality.\r\n\r\n\r\nActivate using the toggle at the top of this section.";
        public static string optionsPlanarReflectionsDescAdditional = "<color=red>[</color>Off<color=red>]</color> <color=red>[</color><color=green>+++ </color>Performance<color=red>]</color>\\r\\n-------------------------------------------------<color=red>[</color>Off<color=red>]</color>                     </color><color=green>+++ </color>Performance    /    <color=red>-- </color>Quality\r\n\r\n\r\n\r\n<color=red>[</color>On<color=red>]</color> <color=red>[</color><color=green>+++ </color>Quality<color=red>]</color>\\r\\n-------------------------------------------------<color=red>[</color>On<color=red>]</color>                      </color><color=red>-- </color>Performance    /    <color=green>+++ </color>Quality";
    }
    #endregion
